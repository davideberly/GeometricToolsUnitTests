...
#include <GTL/Mathematics/Distance/2D/DistSegment2Arc2.h>
using namespace gtl;

namespace gtl
{
    class UnitTestDistSegment2Arc2
    {
    public:
        UnitTestDistSegment2Arc2();
...
UnitTestDistSegment2Arc2::UnitTestDistSegment2Arc2()
{
    UTInformation("Mathematics/Distance/2D/DistSegment2Arc2");

    Test();
}

void UnitTestDistSegment2Arc2::Validate(SCOutput const& output, SCOutput const& expected)
{
...
void UnitTestDistSegment2Arc2::Test()
{
...
GTL_TEST_FUNCTION(DistSegment2Arc2)
