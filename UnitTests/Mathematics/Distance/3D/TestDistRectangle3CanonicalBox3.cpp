...
namespace gtl
{
    class UnitTestDistRectangle3CanonicalBox3
    {
    public:
        UnitTestDistRectangle3CanonicalBox3();

    private:
        using RBQuery = DCPQuery<double, Rectangle3<double>, CanonicalBox3<double>>;
...
UnitTestDistRectangle3CanonicalBox3::UnitTestDistRectangle3CanonicalBox3()
{
    UTInformation("Mathematics/Distance/3D/DistRectangle3CanonicalBox3");

    Test();
}

void UnitTestDistRectangle3CanonicalBox3::Validate(RBOutput const& output,
    double sqrDistance,
    std::array<double, 2> const& cartesian,
    Vector<double, 3> const& closest0,
    Vector<double, 3> const& closest1)
...
void UnitTestDistRectangle3CanonicalBox3::Test()
{
    RBQuery query{};
    RBOutput output{};
    ...
    rectangle.center = { -11.5, -11.0, -10.5 };
    ...
    Validate(output, 298.36873673838159,
        ...
        { -12.079647213087945, -10.481574016239861, -10.325454481068402 },
        { -1.5, -1.0, -0.5 });
}
...
namespace gtl
{
    template class DCPQuery<float, Rectangle3<float>, CanonicalBox3<float>>;
    template class DCPQuery<double, Rectangle3<double>, CanonicalBox3<double>>;

#if defined(GTL_INSTANTIATE_RATIONAL)
    using Rational = BSRational<UIntegerAP32>;
    template class DCPQuery<Rational, Rectangle3<Rational>, CanonicalBox3<Rational>>;
#endif
}
...
GTL_TEST_FUNCTION(DistRectangle3CanonicalBox3)
